      ...
      <div class="box">
        <form class="form form-horizontal" data-toggle="validator" method="post" enctype="multipart/form-data">
          ...
          <div class="box-footer">
              <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-floppy"></i> Simpan Perubahan</button>
          </div>
        </form>
  ...
  function showData(){
    $.ajax({
      ...
      success : function(data){
        ...
        d = new data();
        $('.tampil-logo').html('<img src="public/images/'+data.kartu_member+'?'+d.getTime()+'" width="300">');
      },
      error : function(){
        alert("Tidak dapat menyimpan data!");
      }
