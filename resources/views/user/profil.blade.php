          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                ...
                <br><div class="tampil-foto"> <img src="{{ asset('public/images/'.Auth::user()->foto) }}" width="200">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <input id="password" type="password" class="form-control" name="passwordlama">
                <span class="help-block with-errors"></span>
              </div>
            </div>
